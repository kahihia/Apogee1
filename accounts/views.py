...
class UserDetailView(DetailView, LoginRequiredMixin):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['following'] = UserProfile.objects.is_following(self.kwargs.get('username'), self.get_object())
        context['blocking']  = UserProfile.objects.is_blocking(self.kwargs.get('username'), self.get_object())
        context['blocked'] = UserProfile.objects.is_blocked(self.kwargs.get('username'), self.get_object())
